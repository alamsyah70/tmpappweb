...
<div class="bg-gray-100 p-8 rounded-lg">
    <form method="POST" action="/admin-management/create-nomor-unit" enctype="multipart/form-data">
...
@endif
    <div>
        <label for="nomor_unit" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nomor Unit :</label>
        <input type="teks" id="nomor_unit" name="nomor_unit" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="LV -" required value="{{ old('nomor_unit') }}">
        @error('nomor_unit')
